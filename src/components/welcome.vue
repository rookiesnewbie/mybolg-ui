...
<div class="welcome">
		...
		<ul class="menu cf">
			<li v-for="(item, index) in menuList" :key="index">
				<ul class="no-child">
					...
					<li class="menu-name" v-else @click="linkTo(item.path, index)" :class="{active:index===indexes}">{{item.name}}</li>
				</ul>
		...
		<div class="right-content">
			...
			<div class="link-box">
				...
				<div class="link-content">
					<el-tooltip class="item" effect="dark" content="https://blog.csdn.net/weixin_50117748" placement="top">
						<img class="tag" src="../../static/img/logo/csdn.png" alt="csdn地址" @click="friendsLink('https://blog.csdn.net/weixin_50117748')">

					</el-tooltip>
					<el-tooltip class="item" effect="dark" content="https://github.com/rookiesnewbie" placement="top">
						<img class="tag" src="../../static/img/logo/github.png" alt="Github地址" @click="friendsLink('https://github.com/rookiesnewbie')">
					</el-tooltip>

					<el-tooltip class="item" effect="dark" content="https://gitee.com/lisircode" placement="top">
						<img class="tag" src="../../static/img/logo/gitee.png" alt="Gitee地址" @click="friendsLink('https://gitee.com/lisircode')">
					</el-tooltip>
				...
				<div class="link-content newArtic">
					...
					<div >
						<el-tag type="success" class="tagNewArticle" v-for="item in newArticle" :key="item.id"  @click="toArticleDetail(item.id)">
	...
	<el-popover
		...
		placement="bottom"
		width="100"
		popper-class="set-box"
		trigger="hover">
		<div class="action-cl">
			<p @click="settForm = true">设置</p>
...
.news {
	...
	@keyframes mymove
	{
		from {left:279px;}
		to {left:-472px;}
		0% {color: rgb(207, 157, 157);}
		10% {color: rgb(55, 218, 136);}
		20% {color: rgb(124, 113, 223);}
		30% {color: rgb(235, 132, 172);}
		40% {color: rgb(255, 255, 255);}
		50% {color: rgb(41, 198, 219);}
		60% {color: rgb(235, 193, 193);}
		70% {color: rgb(245, 21, 21);}
		80% {color: rgb(117, 204, 171);}
		90% {color: rgb(73, 143, 137);}
		100% {color: rgb(109, 60, 60);}
	}
}
.kePublic {
	position: absolute;
...
@keyframes lingt {
	...
	100% { box-shadow: 0px 0px 0px #348e8d;}                          /* 动画开始时的不透明度 */
}
.bg-bock {
	height: 200px;
	overflow: hidden;
